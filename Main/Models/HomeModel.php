    ...
    class HomeModel
    {
        ...
        public static function retrieveFriendsPosts(){
			...
			foreach ($amigosConfirmados as $key => $value) {
				...
				$listaAmigos[$key]['id'] = \Main\Models\UsuariosModel::getUsuarioById($value)['id'];

				$listaAmigos[$key]['nome'] = \Main\Models\UsuariosModel::getUsuarioById($value)['nome'];

				$listaAmigos[$key]['email'] = \Main\Models\UsuariosModel::getUsuarioById($value)['email'];
				$listaAmigos[$key]['img'] = \Main\Models\UsuariosModel::getUsuarioById($value)['img'];

				$listaAmigos[$key]['ultimo_post'] = \Main\Models\UsuariosModel::getUsuarioById($value)['ultimo_post'];
			}
