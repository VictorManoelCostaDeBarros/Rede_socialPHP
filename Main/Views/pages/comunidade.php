	...
	<section class="main-feed">
		...
		<div class="feed">
			...
			<div class="container-comunidade">
					...
					<?php 
						foreach(\Main\Models\UsuariosModel::listarAmigos() as $key => $value){
					?>
			...
			<br/>
				...
				<div class="container-comunidade">
					...
					<?php 
						$comunidade = \Main\Models\UsuariosModel::listarComunidade();
					...
					?>
						...
						<div class="container-comunidade-single">
							...
							<?php 
								if(\Main\Models\UsuariosModel::existePedidoAmizade($value['id'])){
							?>
