		...
		<div class="feed">
			...
			<div class="feed-form">
				<form method="post" action="">
					<textarea required name="post_content" placeholder="No que você esta pensando?"></textarea>
			...
			<?php
				$retrievePosts = \Main\Models\HomeModel::retrieveFriendsPosts();
			...
			<div class="friends-request-feed">
				...
				<?php 
					foreach(\Main\Models\UsuariosModel::listarAmizadesPendentes() as $key => $value){
					$usuarioInfo = \Main\Models\UsuariosModel::getUsuarioById($value['enviou'])
				?>
